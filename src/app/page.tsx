...
export default function Home() {
  return (
        ...
        <div className='col-span-2 px-6 lg:px-0 lg:pt-4'>
          ...
          flex flex-col items-center lg:items-start'>
            ...
            <h1 className="relative w-fit tracking-tight  text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">Your image on a  
               <span className="bg-green-600 px-2 text-white">Custom</span> phone case</h1>
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                capture ur fav memories with ur own <span className="font-semibold">one-of-one</span> phone case.
                CaseCobra allows u to protect ur memories, not just ur phone case
              </p>
    ...
    <div className="flex -space-x-4">
      <img src="/users/user-1.png" 
      alt="" 
      className="inline-block h-10 w-10 rounded-full ring-2 ring-slate-100"
      />
      <img src="/users/user-2.png" 
      alt="" 
      className="inline-block h-10 w-10 rounded-full ring-2 ring-slate-100" 
      />
      <img src="/users/user-3.png" 
      alt="" 
      className="inline-block h-10 w-10 rounded-full ring-2 ring-slate-100" 
      />
      <img src="/users/user-4.png" 
      alt="" 
      className="inline-block h-10 w-10 rounded-full ring-2 ring-slate-100" 
      />
      <img src="/users/user-5.png" 
      alt="" 
  ...
  <span className="font-semibold">1,250</span> happy customers
        ...
        <div className="col-span-full lg:col-span-1 w-full flex justify-center
         px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
          ...
          <img src="/your-image.png" alt="" className="absolute w-40 lg:w-52 left-56 -top-20 
          select-none hidden sm:block lg:hidden xl:block" />
          <img src="/line.png" alt="" className="absolute w-20 -left-6 -bottom-6
          select-none" />
...
{/* values proposition section */}
    <section className="bg-slate-100 py-24">
     <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
      <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
        <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight 
        font-bold text-5xl md:text-6xl text-gray-900">What our <span className="relative px-2">customers <Icons.underline className="hidden sm:block pointer-events-none absolute inset-x-0 -bottom-6 text-green-600" />
        </span> {''}
        say</h2>
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
        <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
          ...
          <div className="text-lg leading-8">
            <p>
              "The Case feels durable and I even got a compliment on the design. Had the case for two and half months now and <span className="p-0.5 bg-slate-800 text-white">the image is super clear</span>, on The
              case i had before, The image started fading into yellowish color after a couple of weeks. Love it."
            </p>
          </div>
        ...
        <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
          ...
          <div className="text-lg leading-8">
            <p>
            "I usually keep my phone with my keys in my pocket and that led to some pretty heavy scratches 
            on all of my last phone cases. This one, besides a barely noticable scratch on the corner 
    ...
    <section>
      <MaxWidthWrapper className="py-24">
          <div className="mb-12 px-6 lg:px-8">
            ...
            <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight 
        font-bold text-5xl md:text-6xl text-gray-900">Upload your photo and get <span className="relative px-2 bg-green-600 text-white">your own case
        </span> {''}
        now</h2>
               </div>
          </div>
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            ...
            ring-gray900/10 lg:rounded-2xl">
              <img 
              src="/horse.jpg"
