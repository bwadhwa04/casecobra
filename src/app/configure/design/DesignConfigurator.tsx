...
import { ArrowRight, Check, ChevronsUpDown, ChevronsUpDownIcon } from "lucide-react"
...
const DesignConfigurator = ({
    ...
    return (<div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
        ...
        max-w-full flex items-center justify-center rounded-xl border-2 border-dashed
        border-gray-300 p-12 text-center focus:outline-none focus:ring-2 
        focus:ring-primary focus:ring-offset-2">
            <div className="relative w-60 bg-opacity-50 pointer-event-none
            aspect-[896/1831]">
                <AspectRatio 
                ref={phoneCaseRef}
                ratio={896/1831} 
        ...
        <div className="px-8 pb-12 pt-8">
            ...
            <div className="relative mt-4 h-full flex flex-col justify-between">
                ...
                onChange={(val)=> {
                    ...
                    <div className="mt-3 flex item-center space-x-3">
                        {COLORS.map((color) => (
                            <RadioGroup.Option 
                            key={color.label} 
                            value={color}
                            ...
                            {selectableOptions.map((option)=> (
                                ...
                                className={({active, checked}) => 
                                    cn("relative block cursor-pointer rounded-lg bg-white px-6 py-4 shadow-sm border-2 border-zinc-200 focus:outline-none ring-0 focus:ring-0 outline-none sm:flex sm:justify-between",
                                        {
                                            "border-green-600": active || checked,
                                        }
                                    )}>
     ...
     <div className="w-full px-8 h-16 bg-white">
        ...
        <div className="w-full h-full flex justify-end items-center">
            <div className="w-full flex gap-6 items-center">
                ...
                })} size="sm" className="w-full bg-green-600 hover:bg-green-500">
                    Continue
