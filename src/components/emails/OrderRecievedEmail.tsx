...
const OrderRecievedEmail = ({
    ...
    const baseurl=process.env.NODE_ENV === "development"?"http://localhost:3000" : "http://casecobra-navy.vercel.app"
            ...
            <Container style={container}>
                <Section style={message}>
                    ...
                    <Text style={{...global.text, marginTop: 24}}>
                       ...
                       contact us with your order no. and we are here to help.
                    </Text>
                </Section>
                <Hr style={global.hr} />
                ...
                <Section style={paddingY}>
                  ...
                  <Row>
                    <Text style={footer.text}>
                      ©️CaseCobra Inc. All rights reserved.
                    </Text>
                  </Row>
                </Section>
            </Container>
